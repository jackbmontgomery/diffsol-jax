...
it to a [diffsl](https://martinjrobins.github.io/diffsl/) source string, compiles it once with
[Cranelift](https://cranelift.dev/), and caches the result for subsequent calls.
